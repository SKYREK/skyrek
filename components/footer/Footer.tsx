...
export function Footer() {
  return (
    <div className="bg-black mx-10 mb-10 rounded-xl text-white">
      ...
      <div className="grid grid-cols-3 md:grid-cols-4 gap-10 pt-14 lg:pt-10 px-20 lg:px-32">
        <div className="flex flex-col gap-5 col-span-3 md:col-span-1">
          <p className="text-4xl">Do you Like what you see?</p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2 items-center">
            <Phone size={18} />
            <p className="text-xs md:text-base">+44 123 456 789</p>
          </div>
          <div className="flex gap-2 items-center">
            <Mail size={18} />
            <p>info@Skyrek.lk</p>
      ...
      <div className="flex justify-center items-center text-slate-700 text-5xl md:text-7xl lg:text-[170px] px-20 my-10 tracking-wide">
        Crafting Since 2019
      </div>
      <div className="lg:flex lg:flex-row lg:justify-between items-center px-16 pb-10">
        <div className="flex items-center my-2 lg:my-0">
          <Logo/>
          <Link href="#" className="text-sm text-gray-400 inline-block lg:inline mt-2 lg:my-0 mr-3">
            © Skyrek Ltd 2024.
          </Link>
          <Tally1/>
